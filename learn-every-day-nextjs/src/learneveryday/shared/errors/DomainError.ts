...
export class DomainError extends Error {
  ...
  static readonly TASK_SCHEDULING_FAILED = 'TASK_SCHEDULING_FAILED'; // Deprecated, use HISTORY_SCHEDULING_FAILED
  static readonly HISTORY_SCHEDULING_FAILED = 'HISTORY_SCHEDULING_FAILED';
