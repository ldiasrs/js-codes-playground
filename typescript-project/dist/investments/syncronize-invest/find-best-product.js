...
const filterInvestProducts = (investProducts, filterOptions) => {
    ...
    const investProductsFiltered = investProducts
        ...
        .sort((a, b) => moment(a.resgate, "DD/MM/YYYY").valueOf() - moment(b.resgate, "DD/MM/YYYY").valueOf())
...
const products = readFileSync(config.find_best_investment.input_data_file, 'utf8');
